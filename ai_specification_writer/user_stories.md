...
**As a** Passenger, **I want** the system to automatically calculate and transfer fuel costs **so that** I don't have to handle awkward cash transactions with colleagues.
**Acceptance Criteria**:
...
**As a** Driver, **I want** integrated GPS navigation for the carpool route **so that** I can pick up all passengers efficiently without switching apps.
**Acceptance Criteria**:
...
**As a** User (Driver/Passenger), **I want** an SOS button that alerts corporate security **so that** I feel safe during the commute in case of an emergency.
**Acceptance Criteria**:
