...
- **Acceptance Criteria 2**: User receives a verification link or uses SSO provider.
**Priority**: MVP
...
- **Acceptance Criteria 2**: Driver can specify the number of available seats clearly.
**Priority**: MVP
...
- **Acceptance Criteria 2**: Results are sorted by proximity to the passenger's current home.
**Priority**: MVP
...
- **Acceptance Criteria 2**: Driver can accept or decline the request within the mobile app.
**Priority**: MVP
...
- **Acceptance Criteria 2**: Payment is processed only after the ride is marked as completed by both parties.
**Priority**: High
...
- **Acceptance Criteria 1**: Dashboard displays "Kg of CO2 saved" based on trip distance and vehicle type.
- **Acceptance Criteria 2**: Statistics can be shared directly on the internal corporate portal.
**Priority**: Medium

---

## User Story 7
**As a** Driver, **I want to** use integrated GPS navigation for the carpool route **so that** I can pick up all passengers efficiently without switching between different apps.
- **Acceptance Criteria 1**: The map shows the optimal route with all pickup stops included.
- **Acceptance Criteria 2**: Real-time traffic updates are integrated into the navigation system.
**Priority**: Medium
